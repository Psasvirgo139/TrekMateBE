...
import com.trekmate.backend.dto.response.TourDetailResponse;
...
public class PublicTourController {
        ...
        @GetMapping("/{idOrSlug}")
        @Operation(summary = "Lấy chi tiết tour", description = "Trả về chi tiết tour (có thể truyền UUID hoặc slug) thông qua API công khai")
